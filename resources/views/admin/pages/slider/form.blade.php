...
@php
    ...
    $formInputAttr      =   config('utils.template.formInput');
    $formLabelAttr      =   config('utils.template.formLabel');
    $statusValue        =   ['default'=>'Select status','active'=>config ('utils.template.status.active.name'),'inactive'=>config ('utils.template.status.inactive.name')];
